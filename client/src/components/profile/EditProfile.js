...
const EditProfile = ({setOnEdit}) => {
    const initState = {
        fullname: '', collegeName : '', mobile: '', address: '', website: '', story: '', gender: ''
    }
    const [userData, setUserData] = useState(initState)
    const { fullname, mobile, collegeName , address, website, story, gender } = userData
    ...
    return (
        <div className="edit_profile">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    <label htmlFor="collgeName">College Name</label>
